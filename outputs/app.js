...
const translations = {
  ja: {
    ...
    gameSelectIntro:
      "Mentalcは、暗算、脳トレ、パズルなどを短い時間で遊べるシンプルなゲームサイトです。今後も集中力や計算力を鍛えるゲームを追加していきます。",
    mentalMathLabel: "暗算ゲーム",
    mentalMathTitle: "Mentalc",
    mentalMathBody: "桁数、演算、問題数を選んで、計算力と反応の速さを練習します。",
    ...
    polyominoBody: "形の違うピースを並べて、正方形の盤面をすき間なく埋めます。",
    ...
    aboutBody:
      "Mentalcは、足し算、引き算、掛け算、割り算を短い時間で練習できる暗算ゲームです。桁数と問題数を自由に変えて、暗算練習、計算力トレーニング、脳トレに使えます。",
    howToTitle: "使い方",
    howToBody:
  ...
  en: {
    ...
    gameSelectIntro:
      "Mentalc is a simple game site for quick brain training, mental math, and puzzle games. More games for focus and calculation practice will be added over time.",
    mentalMathLabel: "Mental math game",
    mentalMathTitle: "Mentalc",
    mentalMathBody: "Choose digits, operations, and question count to practice calculation speed and quick responses.",
    ...
    polyominoTitle: "Polyole",
    polyominoBody: "Arrange different shaped pieces to fill a square board without gaps.",
    ...
    aboutBody:
      "Mentalc is a simple mental math game for practicing addition, subtraction, multiplication, and division. Change the digit length and question count for arithmetic practice, calculation training, or brain training.",
  ...
  zh: {
    ...
    gameSelectIntro:
      "Mentalc 是一个简洁的游戏网站，可用于快速进行心算、脑力训练和益智游戏。今后还会继续添加训练专注力和计算能力的游戏。",
    mentalMathLabel: "心算游戏",
    mentalMathTitle: "Mentalc",
    mentalMathBody: "选择位数、运算方式和题数，练习计算能力和反应速度。",
    ...
    polyominoLabel: "益智",
    polyominoTitle: "Polyole",
    polyominoBody: "排列不同形状的方块，完整填满正方形棋盘。",
    ...
    aboutBody:
      "Mentalc 是一款简单的心算游戏，可练习加法、减法、乘法和除法。你可以调整位数和题数，用于心算练习、计算训练和脑力训练。",
    howToTitle: "使用方法",
    howToBody:
  ...
  de: {
    ...
    gameSelectIntro:
      "Mentalc ist eine einfache Spielseite fuer kurze Gehirntrainings, Kopfrechnen und Puzzles. Weitere Spiele fuer Konzentration und Rechentraining werden nach und nach ergaenzt.",
    mentalMathLabel: "Kopfrechenspiel",
    mentalMathTitle: "Mentalc",
    mentalMathBody: "Trainiere Rechentempo und schnelle Reaktionen mit Stellenzahl, Rechenart und Aufgabenanzahl.",
    ...
    polyominoLabel: "Puzzle",
    polyominoTitle: "Polyole",
    polyominoBody: "Lege verschieden geformte Teile so, dass ein quadratisches Feld ohne Luecken gefuellt wird.",
    ...
    aboutBody:
      "Mentalc ist ein einfaches Kopfrechenspiel zum Ueben von Addition, Subtraktion, Multiplikation und Division. Stelle die Anzahl der Stellen und Aufgaben frei ein und nutze es fuer Kopfrechnen, Rechentraining und Gehirntraining.",
  ...
  nl: {
    ...
    gameSelectIntro:
      "Mentalc is een eenvoudige spelsite voor korte hersentraining, hoofdrekenen en puzzels. Later worden meer spellen voor focus en rekenvaardigheid toegevoegd.",
    mentalMathLabel: "Hoofdrekenspel",
    mentalMathTitle: "Mentalc",
    mentalMathBody: "Oefen rekensnelheid en snelle reacties met cijfers, bewerkingen en aantal vragen.",
    ...
    polyominoTitle: "Polyole",
    polyominoBody: "Leg verschillend gevormde stukken neer om een vierkant bord zonder gaten te vullen.",
    ...
    aboutBody:
      "Mentalc is een eenvoudig hoofdrekenspel om optellen, aftrekken, vermenigvuldigen en delen te oefenen. Pas het aantal cijfers en vragen aan voor hoofdrekenen, rekentraining en hersentraining.",
  ...
  ko: {
    ...
    gameSelectIntro:
      "Mentalc는 암산, 두뇌 훈련, 퍼즐 게임을 짧게 즐길 수 있는 간단한 게임 사이트입니다. 집중력과 계산력을 연습할 수 있는 게임을 계속 추가할 예정입니다.",
    mentalMathLabel: "암산 게임",
    mentalMathTitle: "Mentalc",
    mentalMathBody: "자릿수, 연산, 문제 수를 선택해 계산력과 빠른 반응을 연습합니다.",
    ...
    polyominoLabel: "퍼즐",
    polyominoTitle: "Polyole",
    polyominoBody: "서로 다른 모양의 조각을 놓아 정사각형 판을 빈틈없이 채웁니다.",
    ...
    aboutBody:
      "Mentalc는 덧셈, 뺄셈, 곱셈, 나눗셈을 연습할 수 있는 간단한 암산 게임입니다. 자릿수와 문제 수를 자유롭게 설정해 암산 연습, 계산 훈련, 두뇌 훈련에 사용할 수 있습니다.",
    howToTitle: "사용 방법",
    howToBody:
